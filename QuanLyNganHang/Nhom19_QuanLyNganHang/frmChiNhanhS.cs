...
using Nhom19_QuanLyNganHang;

namespace Nhom19_QuanLyNganHang
{
    public partial class frmChiNhanhS : Form
    {
        public frmChiNhanhS()
        {
            InitializeComponent();
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlParameter paraDC = new SqlParameter("@diaChi", txtDiachi.Text);
        ...
        private void dgvChinhanh_DoubleClick(object sender, EventArgs e)
        {
            ...
            string maCN = dgvChinhanh.CurrentRow.Cells[0].Value.ToString();

            frmHienThiNhanVienS f = new frmHienThiNhanVienS(maCN);
            f.ShowDialog();
        }
        ...
        {
            frmHienThiDSSinhVienTheoChiNhanhS frm = new frmHienThiDSSinhVienTheoChiNhanhS();
            frm.Show();
        }
    }
}
